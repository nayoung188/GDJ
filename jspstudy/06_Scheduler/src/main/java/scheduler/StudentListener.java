...
public class StudentListener implements ServletContextListener {
	...
	// constructor
	// Scheduler scheduler 생성   (리스너가 동작하면 스케쥴러 생성 가능)
    ...
    public void contextInitialized(ServletContextEvent arg0)  { 
    	...
    	/*
    		Cron Expression (크론식)  - www.cronMaker.com 참고
    		
    		1. 구성
    			초 분 시 일 월 요일 [년도]
    			
    		2. 상세
    			1) 초 : 0 ~ 59  0/1 : 1초마다 동작
    			2) 분 : 0 ~ 59  0/1 : 1분마다 동작
    			3) 시 : 0 ~ 23
    			4) 일 : 1 ~ 31
    			5) 월 : 0 ~ 11 또는 JAN, FEB, MAR, APR, MAY, JUN, JUL, AUS, SEP, OCT, NOV, DES
