			...
			$.ajax({
				...
				success: function(resData){
					...
					$.each(resData.boxOfficeResult.dailyBoxOfficeList, function(i,movie){
						$('<tr>')
						.append($'<td>').text(resData.rank)
						.append($'<td>').text(resData.movieNm)
						.append($'<td>').text(resData.openDt)
						.append($'<td>').text(resData.audiCnt)
						.append($'<td>').text(resData.audiAcc)
						.append($'</tr>')
