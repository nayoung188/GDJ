...
public class RequestLoggingAspect {
	...
	@Pointcut("within(com.gdu.app12.controller..*)")		// controller 패키지 아래 모든 패키지의 모든 클래스 .  컨트롤러의 모든 메소드를 포인트컷으로 지정하겠다.
															// 컨트롤러의 모든 메소드에서 어드바이스 (콘솔에 로그찍기)가 동작한다.
	...
	@Around("com.gdu.app12.aop.RequestLoggingAspect.setPointCut()")			// setPointCut()메소드에 설정된 포인트컷에서 동작하는 어드바이스
	public Object executeLogging(ProceedingJoinPoint joinPoint) throws Throwable {		 // @Around는 반드시 ProceedingJoinPoint joinPoint을 선언해야함
