...
<body>
	...
	<div>
		...
		<form id="frm_join" action="${contextPath}/user/join" method="post">
			...
			<!-- 약관 동의 여부 -->
			<input type="hidden" name="location" value="${location}">		<!-- name으로 넘어오기 때문에 null이 오지 않고 빈칸이 옴 -->
			<input type="hidden" name="promotion" value="${promotion}">		<!-- name으로 넘어오기 때문에 null이 오지 않고 빈칸이 옴 -->
			...
			<!-- 주소 -->
			<div>
				<input type="text" name="postcode" id="postcode" placeholder="우편번호" onclick="fn_execDaumPostcode()" readonly="readonly">
