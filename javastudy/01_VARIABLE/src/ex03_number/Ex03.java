...
public class Ex03 {
	...
	public static void main(String[] args) {
		...
		// balance = balance + balance * 0.05; 실패. balance * 0.5 결과는 double 이기 때문에 long balance에 저장할 수 없다.
		// balance = (long)(balance + balance * 0.05); 성공. balance * 0.05 결과를 long으로 casting해서 저장할 수 있다.
