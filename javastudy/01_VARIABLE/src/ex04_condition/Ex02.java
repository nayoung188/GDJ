...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		// 연습
		// 변수 n보다 10 증가시킨 뒤 n이100보다 크다면 true 아니면 false
		int n = 95;
		n += 10;
		...
		int i = 10;
		int j = 10;
		boolean result9 = ( i == 20) && ( ++j == 11 );   // i가 false가 나왔기 때문에 이후 j연산은 진행하지 않으므로 j= 10
		System.out.println(result9);  //false
		System.out.println(j);  // 11이 아니라 10
		boolean result10 = ( i == 10 ) || ( ++j == 11);   // i가 true가 나왔기 때문에 이후 j연산은 진행하지 않으므로 j= 10
